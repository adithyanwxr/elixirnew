...
const images = [
  { src: "/individual-projects/img1.webp", category: 0 },
  { src: "/individual-projects/img2.webp", category: 0 },
  { src: "/project-detailed/img1.webp", category: 0 },
      ...
      <div className="w-[95%] sm:w-[90%] xl:w-[87%] max-w-350 mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-14">
          <div className=" lg:max-w-md">
            <MotionWrapper>
              <p className="taghead-text text-[#8B8E72] font-inter">ELIXIR ANFIELD</p>
            </MotionWrapper>
            <MotionWrapper>
            ...
            <MotionWrapper>
              <p className="normal-text font-inter text-white lg:w-[80%] mt-[1.6rem]">
                ...
                uncompromised quality. architecture and uncompromised quality.
              </p>
            </MotionWrapper>
          </div>
