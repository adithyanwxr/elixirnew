...
const images = [
  ...
  { src: "/completed-projects/g1.webp", category: 0 },
  { src: "/completed-projects/g2.webp", category: 0 },

  { src: "/blog/b1.webp", category: 0 },
  { src: "/blog/b1.webp", category: 0 },
  ...
  return (
    <section className="w-full elixir-black-bg text-white pt-[6.3rem] pb-142">
      ...
      <div className="w-[95%] sm:w-[90%] xl:w-[87%] max-w-350 mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-14">
          <div className=" lg:max-w-md">
            <MotionWrapper>
              <p className="taghead-text text-[#8B8E72] font-inter">Elixir Manavath Heights </p></MotionWrapper>
            <MotionWrapper>
            ...
            <MotionWrapper>
              <p className="normal-text font-inter text-white lg:w-[80%] mt-[1.6rem]">
                The Elixir Manavath Heights is all about luxury and comfort. We had put all our focus to provide extreme comfort as well as luxury
              </p>
            </MotionWrapper>
          </div>
      ...
      <MotionWrapper className="mt-[4.8rem] w-full relative">
        ...
        <div className="w-[95%] sm:w-[90%] xl:w-[87%] max-w-[1400px] mx-auto">
