...
export default function LocationSection() {
  const items = [
    { time: "1-2 Minutes", label: "City amenities within reach" },
    { time: "5-8 Minutes", label: "Reputed Schools" },
    { time: "2-3 Minutes", label: "Popular Restaurants" },
    { time: "10-12 Minutes", label: "Thrissur City Access" },
    { time: "40 Minutes", label: "Airport (Cochin International Airport)" },
    { time: "5 Minutes", label: "Daily Essentials & Lifestyle Stores" },
  ];
