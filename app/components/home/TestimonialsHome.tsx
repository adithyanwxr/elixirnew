  ...
  return (
    <>
      <div className="w-full elixir-black-bg md:pb-0">
        <div className="w-[95%] sm:w-[90%] xl:w-[86.9%] max-w-350 mx-auto pt-20 pb-7.5 lg:pt-30 lg:pb-12.5  xl:pt-50 2xl:pt-50 xl:pb-19.25">
          <div className="w-full h-fit flex justify-between">
            ...
            <MotionWrapper className=" relative hidden lg:flex items-end justify-end min-h-full md:w-[48%] lg:w-[50%] xl:w-[418.5px]  ">
              <div className="flex">
                <button
                  onClick={handlePrev}
