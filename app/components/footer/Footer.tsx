 ...
 <MotionWrapper className="flex justify-start items-start lg:justify-end lg:items-end w-full">
  ...
  <MotionWrapper className=" md:w-1/2 lg:w-[22%]">
    ...
    <ul className="space-y-5">
      <li><a href="" className="text-white para-text font-inter">Home</a></li>
      <li><a href="/about" className="text-white para-text font-inter">Our Story</a></li>
      <li><a href="/projects" className="text-white para-text font-inter">Projects</a></li>
      <li><a href="/gallery" className="text-white para-text font-inter">Gallery</a></li>
      <li><a href="/testimonials" className="text-white para-text font-inter">Testimonial</a></li>
    </ul>
  </MotionWrapper>
  ...
  Quick Links
    ...
    <ul className="space-y-5 mt-[3.4rem] md:mt-0">
      <li><a href="/insights" className="text-white para-text font-inter">Insights</a></li>
      <li><a href="/faq" className="text-white para-text font-inter">FAQ</a></li>
      <li><a href="/contact" className="text-white para-text font-inter">Contact</a></li>
      <li><a href="/legal-and-policy" className="text-white para-text font-inter">Legal And Policy</a></li>
    </ul>
  </MotionWrapper>
  ...
  <MotionWrapper className="md:w-1/2 lg:w-[23%]">
    ...
    <ul className="space-y-5">
      <li><a href="/elixir-anfield" className="text-white para-text font-inter">Elixir Anfield</a></li>
      <li><a href="/orchid" className="text-white para-text font-inter">The Orchid</a></li>
      <li><a href="/elixir-akkara-garden" className="text-white para-text font-inter">Elixir Akkara Gardens</a></li>
      <li><a href="/elixir-manavath-heights" className="text-white para-text font-inter">Elixir Manavath Heights</a></li>
      <li><a href="/elixir-super-luxury-villas" className="text-white para-text font-inter">Elixir Super Luxury Villas</a></li>
...
Ground Floor (Below SBI Kuttanellur Branch) Kuttanellur P.O, Thrissur, Kerala-680014
      </p>
    </div>
  ...
  <div className="space-y-4 max-w-md mx-auto">
    ...
    <div className=" items-center gap-3">
      ...
      <p className="text-white para-text font-inter text-center">
        <span className="font-medium">Elixir Villas & Apartments Pvt.Ltd.</span> <br />
