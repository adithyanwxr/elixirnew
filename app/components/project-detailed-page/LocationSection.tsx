...
export default function LocationSection() {
  const items = [
    { time: "1 Minute", label: "Regency Club, Kuttanellur,\nThrissur" },
    { time: "5-8 Minutes", label: "Leading Schools &\nEducational Institutions" },
    { time: "7-12 Minutes", label: "Hospitals & Healthcare\nCenters" },
    { time: "10-15 Minutes", label: "Thrissur Town & Swaraj\nRound" },
    { time: "2-5 Minutes", label: "Shopping Centres & Daily\nEssentials" },
    { time: "5 Minutes", label: "Restaurants, Cafés &\nEntertainment Zones" },
  ];

  return (
    <section className="w-full bg-white pt-24 lg:pt-[12.4rem] relative pb-20 lg:pb-0 ">
