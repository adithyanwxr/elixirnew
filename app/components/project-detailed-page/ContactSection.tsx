...
export default function ContactSection() {
  ...
  return (
    <section className="w-full bg-white py-28  md:py-50 lg:pt-80 xl:pt-112 2xl:pt-144">
  ...
  flex flex-col xl:flex-row items-center xl:items-start gap-7"
            >
              ...
              <div className="flex flex-col items-start justify-start">
                <MotionWrapper>
                  <p className="text-[28px] font-cormorant text-black leading-[1.3]">
                    For Sales Assistance
                  </p>
                </MotionWrapper>
                <MotionWrapper>
                  <p className="text-[16px] font-inter mt-5 text-[#7b7b7b] leading-[1.8]">
